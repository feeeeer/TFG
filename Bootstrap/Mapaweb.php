  ...
  <body style="background-color: #FFFEF7;">
    ...
    <nav aria-label="breadcrumb">
      <ol class="migas_de_pan breadcrumb" style="background-color: #FFFEF7;">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php echo $mapaweb; ?></li>
      </ol>
    </nav>
    <div class="container">
      <h1 class="titulo1"><?php echo $mapaweb; ?> </h1>
      <ul>
        <li><a href="https://www.upm.es/" title="www.upm.es"><abbr title="Universidad Politécnica de Madrid">UPM</abbr></a></li>
        <li><a href="https://www.fi.upm.es/" title="www.fi.upm.es"><abbr title="Escuela Técnica Superior de Ingenieros Informáticos">ETSIInf</abbr></a></li>
        <li><a href="index.php"> <abbr title="<?php echo $dlsiis; ?>">DLSIIS</abbr></a></li>
        <li><a title="<?php echo $docencia; ?>"><?php echo $docencia; ?></a>
        <ul>
          <li><a href="Grado.php" title="<?php echo $grado; ?>"><?php echo $grado; ?></a></li>
          <li><a href="Master.php" title="<?php echo $master; ?>"><?php echo $master; ?></a></li>
          <li><a href="Doctorado.php" title="<?php echo $doctorado; ?>"><?php echo $doctorado; ?></a></li>
        </ul>
        </li>
        <li><a title="Profesorado"><?php echo $profesorado; ?></a>
        <ul>
          <li><a href="Buscarpornombre.php" title="<?php echo $buscar_nombre; ?>"><?php echo $buscar_nombre; ?></a></li>
          <li><a href="Buscarporasignatura.php" title="<?php echo $buscar_asig; ?>"><?php echo $buscar_asig; ?></a></li>
          <li><a href="Todoslosprofesores.php" title="<?php echo $mostrar_todos; ?>"><?php echo $mostrar_todos; ?></a></li>
        </ul>
        </li>
        <li><a title="<?php echo $investigacion; ?>"><?php echo $investigacion; ?></a>
        <ul>
          <li><a href="Grupos.php" title="<?php echo $grupos; ?>"><?php echo $grupos; ?></a></li>
          <!--li><a href="#" title="Líneas">Líneas</a></li-->
        </ul>
        </li>
        <li><a href="Contacto.php" title="<?php echo $contacto; ?>"><?php echo $contacto; ?></a></li>
        <li><a href="Accesibilidad.php" title="<?php echo $accesibilidad; ?>"><?php echo $accesibilidad; ?></a></li>
        <li><a href="Mapaweb.php" title="<?php echo $mapaweb; ?>"><?php echo $mapaweb; ?></a></li>
      </ul>
    </div>
