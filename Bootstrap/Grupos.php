...
<html lang="<?php echo $idioma;?>">
  <head>
    ...
    <title>DLSIIS - Investigación</title>
  </head>
  <body style="background-color: #FFFEF7;">
        ...
        <div class="navbar-nav-scroll">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown active">
              <a class="nav-item nav-link dropdown-toggle mr-md-2" href="#" id="bd-versions3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <nav aria-label="breadcrumb">
      <ol class="migas_de_pan breadcrumb" style="background-color: #FFFEF7;">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php echo $grupo_inv; ?></li>
      </ol>
    </nav>
    <div class="container">
      <h1 class="titulo1"><?php echo $grupo_dep; ?></h1>
      <ul class="lista_sin_estilo">
				<?php echo $grupos_investigacion; ?>
	    </ul>
    </div>
    <br>
    <br>
