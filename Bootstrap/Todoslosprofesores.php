  ...
  <body style="background-color: #FFFEF7;">
    ...
    <div class="container">
      ...
      <ul class="lista_sin_estilo">
        ...
        // Cargamos los titulos de Doctorado ordenados alfabeticamente
        $sql_profesores = "SELECT * FROM profesores WHERE otro_departamento = '0' ORDER BY nombre_completo ASC";
        // Comprobamos la carga
        if (mysqli_query($conn, $sql_profesores)) {
          $result_profesores = mysqli_query($conn, $sql_profesores);
        }
        else {
          echo "Error: ".$sql_profesores ."<br>".mysqli_error($conn);
        }
