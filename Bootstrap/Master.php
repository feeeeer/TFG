  ...
  <body style="background-color: #FFFEF7;">
    ...
    <nav aria-label="breadcrumb">
      <ol class="migas_de_pan breadcrumb" style="background-color: #FFFEF7;">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php echo $master; ?></li>
      </ol>
    </nav>
    <div class="container-fluid">
      <h1 class="titulo1" style="margin-left:32px;"><?php echo $masteres;  ?></h1>
      <?php
      require_once ('loginBD.php');
      // Cargamos los titulos de Master ordenados alfabeticamente
      $sql_titulos = "SELECT * FROM titulaciones where codigo_subtipo='MOF' ORDER BY `titulaciones`.`nombre` ASC";
      ...
      while ($row_titulos =mysqli_fetch_array($result_titulos)) {
        ...
        while ($row_asignaturas =mysqli_fetch_array($result_asignaturas)) {
          ...
          if($arrayCodigo[$list] == $row_asignaturas["codigo_titulacion"] && $row_asignaturas["nombre_tipo_asignatura"] != "-"){
                    ...
                    <a href="Asignatura.php?codigo_tit_asig='.$row_asignaturas["id"].'&id_tit='.$row_asignaturas["codigo_titulacion"].'&tipo_tit=Máster">'.$nomb_asig.'</a><br>
                  </li>';
          }
        }
        echo '</ul>';
