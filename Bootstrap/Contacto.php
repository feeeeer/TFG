  ...
  <body style="background-color: #FFFEF7;">
    ...
    <nav aria-label="breadcrumb">
      <ol class="migas_de_pan breadcrumb" style="background-color: #FFFEF7;">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php echo $contacto; ?></li>
      </ol>
    </nav>
    <div class="row container" style="width:90%;margin-left: auto;margin-right: auto;">
      <div class="container-fluid col">
        <h1 class="titulo1"><?php echo $contacto; ?> </h1>
        <dl class="lista_contacto">
          <?php echo $contacto_izq; ?>
        </dl>
      </div>
      <div class="container-fluid col">
        <?php echo $contacto_der; ?>
        <figure>
          <img class="img-fluid img-thumbnail" src="Pictures/montegancedo.jpg" title="<?php echo $campus; ?>" alt="<?php echo $campus; ?>" />
        </figure>
      </div>
    </div>
    <br><br>
