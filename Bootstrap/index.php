...
<html lang="<?php echo $idioma;?>">
  ...
  <body style="background-color: #FFFEF7;">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" style="min-width: 180px;" aria-labelledby="bd-versions2">
                ...
                <!-- DUDA: Preguntar si es más cómodo incluir las tutorías en el apartado de profesorado o hacerlo por otro lado -->
                <!-- Dejo mostradas las lineas en caso de que sea mejor hacerlo aparte (se comenzaria a poner despues de haber cerrado la li de profesorado) -->
                <!-- <li class="nav-item dropdown">
                      <a class="nav-item nav-link dropdown-toggle mr-md-2" href="#" style="color:#B3BCC3;" id="bd-versions2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <?php echo $profesorado; ?> en lugar de $profesorado habria que crear otra variable que se llame tutorias
                      </a> 
                      <div class="dropdown-menu" style="min-width: 180px;" aria-labelledby="bd-versions2"> -->
                <a class="dropdown-item-text"><?php echo $buscartutoria; ?></a>
                <a class="dropdown-item" href="TodaslasTutorias.php">- <?php echo $mostrartutorias; ?></a>
    ...
    <div class="container" >
      <h1 class="titulo1"><?php echo $dlsiis; ?></h1>
      <div class="container-fluid div_index">
        <?php echo $contenido; ?>
      </div>
			<!--TABLON DE AVISOS-->
			<div class="container">
				<table class="table">
					<?php echo $caption; ?>
						<?php
						require_once ('Avisos/func_avisos.php');
							actualizarAvisos();
							if ($idioma == 'en'){
								imprimirAvisosEng(16);
							}
							else {
								imprimirAvisosEsp(16);
							}
				    ?>
				</table>
			</div>
