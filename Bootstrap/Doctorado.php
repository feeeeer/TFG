  ...
  <body style="background-color: #FFFEF7;">
    ...
    <nav aria-label="breadcrumb">
      <ol class="migas_de_pan breadcrumb" style="background-color: #FFFEF7;">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php echo $doctorado; ?></li>
      </ol>
    </nav>
    <div class="container-fluid">
      <h1 class="titulo1" style="margin-left:32px;"><?php echo $doctorado; ?>s</h1>
      <?php
      require_once ('loginBD.php');
      // Cargamos los titulos de Doctorado ordenados alfabeticamente
      $sql_titulos = "SELECT * FROM titulaciones where codigo_subtipo='DOF' ORDER BY `titulaciones`.`nombre` ASC";
